...
const HorizonCanvas = dynamic(() => import("@/components/EndlessHorizon"), { ssr: false });
...
export default function HorizonPage() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-black text-white">
      <header className="shrink-0 border-b border-border bg-black/80 backdrop-blur-2xl shadow-card z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <span className="overline text-accent/50">The Endless Horizon</span>
